...
# 定义蛇的图片路径和位置
filename = "D:/Python/All_Python_Project/Final_assignments/source/assets/images/snake.png"
location = (10, 150)
snake1 = Snake(filename, location)

# 定义第二个蛇的图片路径和位置
location_2 = (450, 60)
snake2_filename = 'D:/Python/All_Python_Project/Final_assignments/source/assets/images/logo.png'
