...
# 加载首页背景图片
start_menu_background_path = os.path.join(os.getcwd(), 'source', 'assets', 'images', 'start_menu.png')
...
# 加载结束背景图
passed_menu_background_path = os.path.join(os.getcwd(), 'source', 'assets', 'images', 'passed_menu.png')
...
# 加载游戏失败页面背景
died_menu_background_path = os.path.join(os.getcwd(), 'source', 'assets', 'images', 'died_menu.png')
...
restart_button_path = os.path.join(os.getcwd(), 'source', 'assets', 'images', 'restart_button.png')
restart_button_img = pg.image.load(restart_button_path).convert_alpha()
restart_game_button_path = os.path.join(os.getcwd(), 'source', 'assets', 'images', 'restart_game_button.png')
